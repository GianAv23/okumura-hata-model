...
large_urban = 69.55 + 26.16*log10(fc) + (44.9 - 6.55*log10(ht)) * log10(d) - 13.82*log10(ht) - ahr;

%% Sub-Urban City
% --- Menghitung Faktor Koreksi Ketinggian Antena ---
ahr_subrural = ((1.1 * (log10(fc))) - 0.7)*hr - ((1.56*log10(fc))-0.8);

% --- Menghitung Path Loss untuk Daerah Sub-Urban Medium Size ---
medium_urban = 69.55 + 26.16*log10(fc) + (44.9 - 6.55*log10(ht)) * log10(d) - 13.82*log10(ht) - ahr_subrural;
